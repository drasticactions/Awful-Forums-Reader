...
namespace AwfulForumsReader.Pages
{
    ...
    public sealed partial class NewThreadPage : Page
    {
        ...
        {
            Locator.ViewModels.NewThreadVm.PostNewThreadReplyCommand.Execute(ReplyText);
        }

        private void PostIconButton_OnClick(object sender, RoutedEventArgs e)
        {
            Locator.ViewModels.NewThreadVm.NavigateToPostIconPageCommand.Execute(ReplyText);
        }

        private void BBCodeButton_OnClick(object sender, RoutedEventArgs e)
        {
            Locator.ViewModels.NewThreadVm.NavigateToBbCodePageCommand.Execute(ReplyText);
        }

        private void SmileButton_OnClick(object sender, RoutedEventArgs e)
        {
            Locator.ViewModels.NewThreadVm.NavigateToSmiliesPageCommand.Execute(ReplyText);
        }
        private void PreviewButton_OnClick(object sender, RoutedEventArgs e)
        {
            Locator.ViewModels.NewThreadVm.NavigateToPreviewThreadCommand.Execute(ReplyText);
        }
        private void ImgurButton_OnClick(object sender, RoutedEventArgs e)
        {
            Locator.ViewModels.NewThreadVm.ImgurAddImageCommand.Execute(ReplyText);
        }
