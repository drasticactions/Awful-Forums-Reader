...
namespace AwfulForumsReader.ScrollViewer
{
    public sealed class PullToRefreshScrollViewer : ContentControl
    {
        ...
        public static readonly DependencyProperty RefreshHeaderHeightProperty = DependencyProperty.Register("RefreshHeaderHeight", typeof(double), typeof(PullToRefreshScrollViewer), new PropertyMetadata(30D));
        ...
        private void Timer_Tick(object sender, object e)
        {
            if (containerGrid != null)
            {
                ...
                else if (Math.Round(compressionOffset) <= 0 && isReadyToRefresh == true)
                {
                    InvokeRefresh();
                }
                else
