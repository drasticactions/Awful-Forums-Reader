...
SA.utils = new function(e, f, a) {
    ...
    g.qs = function(a) {
        if (a) {
            var g = [], d;
            for (d in a)
                g.push(encodeURIComponent(d) + "=" + encodeURIComponent(a[d]));
            return g.join("&");
        }
        a = {};
        if (g = e.location.search)
            for (var g = g.substr(1).split("&"), j = 0; j < g.length; j++)
                d = g[j].indexOf("="), -1 == d ? a[g[j]] = "" : a[decodeURIComponent(g[j].substr(0, d))] = decodeURIComponent(g[j].substr(d + 1));
        return a;
    };
    e.rf = function(e) {
...
new function(e, f, a) {
    var g = a.browser.webkit || a.browser.safari ? "body" : "html",
        ...
        b = function() {
            i.offset();
            var b = a(g).scrollTop(), h = { position: "absolute", top: k }, e = a("div#content"), j = e.offset().top, e = e.height(), j = j + e - d;
    ...
    a(f).ready(function() {
        var c = a("div.oma_pal"),
            h = a(new Image);
        h.attr({ width: 88, height: 88, "class": "omapalpet" });
        h.css("display", "block");
        c.each(function(d, b) {
            var b = a(b), c = h.clone();
            c.addClass("left");
...
new function(e, f, a) {
    ...
    a(f).ready(function() {
        ...
        d.length && d.each(function(d, b) {
            var b = a(b), c = b.append("<div></div>"), h = b.parents("tr").eq(0), j = i.exec(h.attr("id"));
            if (j) {
                j =
                    j[1];
                c.click(function() {
                    ...
                    a.post("/bookmarkthreads.php", { threadid: j, action: "cat_toggle", json: 1 }, function(a) {
                ...
                var g = h.find("div.lastseen"), f = g.find("a.x");
                f.click(function() {
                    if (f.data("busy"))
                        return !1;
                    f.data("busy", !0);
                    f.html("<");
                    a.post("/showthread.php", { threadid: j, action: "resetseen", json: 1 }, function(a) {
        ...
        var j = !1, b = a("div#bookmark_link a"), c = a("img.thread_bookmark");
        if (b.length && c.length) {
            var h = parseInt(a("body").attr("data-thread"), 10),
                ...
                f = function() {
                    ...
                    }) : c.attr({ src: "http://fi.somethingawful.com/images/buttons/button-unbookmark.png", alt: "Unbookmark", title: "Unbookmark thread" });
                },
                d = function() {
                    if (j)
                        return !1;
                    j = !0;
                    var b = { action: c.hasClass("unbookmark") ? "remove" : "add", threadid: h, json: 1 };
        ...
        if (a("body").hasClass("usercp") || a("body").hasClass("bookmark_threads"))
            d =
                ...
                var b = a(this), d = b.parents("tr").eq(0), c = i.exec(d.attr("id"));
                if (c) {
                    c = c[1];
                    if (b.data("pending"))
                        return !1;
                    ...
                    b.removeClass("warn");
                    b.addClass("spin");
                    a.post("/bookmarkthreads.php", { threadid: c, action: "remove", json: 1 }, function() {
                        d.remove();
                    });
                }
                return !1;
        ...
        if (e.length) {
            ...
            0 >= k || isNaN(k) || e.delegate("ul.rating_buttons li", "click",
                function() {
                    ...
                    a.post("/threadrate.php", { threadid: k, vote: d }, function() {
...
new function(e, f, a) {
    var g = "_sessl",
        ...
        k = function(a) {
            for (var a = a.substr(1).split("&"), e = 0, b, c = {}, h = a.length, f; e < h; e++)
                b = a[e].indexOf("="), -1 != b && (f = a[e].substr(0, b), b = a[e].substr(b + 1), c[f] = b);
            return c;
        };
    a(f).ready(function() {
        if (a("div#notregistered").length) {
            ...
            if (d) {
                ...
                var f = !0, h = i((new Date).getTime() / 1E3), n = a.cookie(g);
                if (n && (value = n.split("."), 4 == value.length)) {
                    var n = i(value[0]), t = i(value[1]), w = i(value[2]), l = i(value[3]);
                    180 > h - l && (f = !1, n == d && t == b && w == c || (f = !0));
                }
                f && (d = [d, b, c, h].join("."),
                    a.cookie(g, d, { expires: 10, domain: "forums.somethingawful.com" }), a("body").append('<img src="/s/' + d + '" alt="">'));
            }
        }
    });
}(window, document, jQuery);
...
SA.timg = new function(e, f, a) {
    var g = this,
        i = function(d, f) {
            var b = a(this).siblings("img"), c, h;
            if (b.attr("t_width"))
                a(this).removeClass("expanded"), b.attr({ width: b.attr("t_width"), height: b.attr("t_height") }), b.removeAttr("t_width"), b.removeAttr("t_height");
            else {
                a(this).addClass("expanded");
                b.attr({ t_width: b.attr("width"), t_height: b.attr("height") });
                ...
                if (f && c > g) {
                    var i = b.position(), g = (g - 3 * i.left) / c;
                    b.attr("width", c * g);
                    b.attr("height", h * g);
                } else
                ...
                c < h && (h = c);
                h != a(g).scrollTop() && (a.browser.msie && 7 > parseInt(a.browser.version, 10) ? a(g).scrollTop(h) : a(g).animate({ scrollTop: h }, 150));
            }
            return !1;
        },
        k = function() {
            ...
            if (d.hasClass("loading")) {
                ...
                if (200 > b && 500 >= e || 170 > e)
                    ...
                    d.addClass("complete");
                    d.attr({ o_width: e, o_height: b });
                    var e = e + "x" + b, b = 1, c = d[0].naturalWidth || d.width(), h = d[0].naturalHeight || d.height();
                    170 < c && (b = 170 / c);
                    200 < h * b && (b = 200 / h);
                    d.attr({ width: c * b, height: h * b });
                    ...
                    b.click(function(b) {
                        if (1 ===
                            b.which || a.browser.msie && 9 > parseInt(a.browser.version, 10) && 0 === b.which)
                            return i.call(f, b, !0), !1;
                    });
                }
...
(function(e, f, a) {
    var g = !1,
        ...
        D = function(a) {
            if (A && null !== a) {
                var b = null, a = "postreply_" + a;
                if (1 < arguments.length)
                    b = arguments[1], null === b ? localStorage.removeItem(a) : localStorage.setItem(a, JSON.stringify(b));
                else if (b = localStorage.getItem(a), null !== b)
                    return JSON.parse(b);
            }
            return null;
        },
        ...
        H = function() {
            if (A && (null === b || 1 < b.length)) {
                ...
                D(c, { time: e.getTime(), message: a.trim(d[0].value) });
            }
        },
        z = function() {
            clearInterval(h);
            if (null !== b) {
                ...
                var a = q();
                b.push({ selection: a, scroll: d[0].scrollTop, text: d[0].value });
                c = b.length - 1;
            }
            H();
        },
        ...
        q = function() {
            var a = null;
            "new" == x && (a = { start: d[0].selectionStart, end: d[0].selectionEnd });
            return a;
        },
        u = function(a) {
        ...
        K = function(a) {
            for (var b = [[0, 47], [58, 64], [91, 96], [123, 126]], d = 0, e = b.length, c = !1; d < e; d++)
                if (a >= b[d][0] && a <= b[d][1]) {
                    c = !0;
                    break;
                }
        ...
        L = function(a) {
            var b = q(), e = d[0].value, c = e.lastIndexOf("[" + a, b.start);
        ...
        M = function(a) {
            var a = a.split("&"), b = {}, d, c;
            for (c in a)
                d = a[c].indexOf("="), -1 != d ? b[a[c].substr(0, d)] = a[c].substr(d + 1) : b[a[c]] = !0;
            return b;
        },
        P = function() {
            var a = q(),
        ...
        Q = function(a) {
            ...
            if (a.originalEvent.metaKey || a.originalEvent.ctrlKey) {
                ...
                case 73:
                    ...
                    break;
                case 76:
                    var h = q(), f = d[0].value, g = f.substring(0, h.start), e = f.substring(h.start, h.end), i = "[list]\n[*]" + e + "\n[/list]", f = f.substr(h.end);
                    d[0].value = g + i + f;
                ...
                case 86:
                    ...
                    setTimeout(function() {
                        ...
                        if (/^https?:\/\//.test(c) && -1 == c.indexOf("\n") && -1 == c.indexOf("\r")) {
                            ...
                            if (h) {
                                var f = { scheme: h[1], domain: h[2], path: h[3] || "", filename: "", query: {}, fragment: "" }, h = f.path.lastIndexOf("#");
                            ...
                            /^([^\.]+\.)?youtube(-nocookie)?\.com$/.test(e.domain) && (e.query.v ? (c = '[video type="youtube"', e.query.hd && (c += ' res="hd"'), e.fragment && (g = M(e.fragment), g.t && (c += ' start="' + parseInt(g.t, 10) + '"')), c += "]" + e.query.v + "[/video]",
                                g = !0) : /^\/embed/.test(e.path) && (c = '[video type="youtube"', e.query.hd && (c += ' res="hd"'), e.query.start && (c += ' start="' + parseInt(e.query.start, 10) + '"'), c += "]" + e.path.substr(e.path.lastIndexOf("/") + 1) + "[/video]", g = !0));
                            if (!g)
                                switch (h) {
                                case "jpg":
                                case "gif":
                ...
                if (null !== h && (b = q(), null !== b)) {
                    if (!a.shiftKey && b.start == b.end) {
                        ...
                        for (g.start = i; i < f && !K(e.charCodeAt(i));)
                            i++;
                        g.end = i;
                        b = g;
                    }
                ...
                if (null !== h)
                    return s(h, null, !1), a.preventDefault(), a.stopPropagation(), !1;
                v();
            }
            return !0;
        },
        p = function() {
            var b = l.find("div.character-count"), c = d[0].value.length;
            C = c;
            if (0 < c && 5E4 >= c && b.hasClass("over"))
            ...
            B ? c = Math.round(1E5 *
                Math.random()) - 5E4 : 3E4 < c && !b.is(":visible") && b.show();
            b.text(c + " / 50000");
        };
    a(f).ready(function() {
        ...
        if (r || y || F) {
            ...
            N && !r && (a(f).delegate('td.postlinks > ul.postbuttons > li > a[href^="newreply.php"]', "click", O), m = a("div#content > div.standard"), m.length || (m = a('<div class="standard"><h2>Post Preview:</h2><div class="inner postbody"></div></div>'), m.css("width", "100%"), m.hide(), a("div#content > div.breadcrumbs").after(m)));
            if (A) {
                ...
                if (null !== c && c.message != w) {
                    var h = l.find("div.save-state"), g = new Date(c.time);
                    ...
                    r || (g = a('<a href="#">Preview</a>'), g.click(function() {
                        var b = c.message, e = { action: a('input[name="action"]').val(), threadid: a('input[name="threadid"]').val(), formkey: a('input[name="formkey"]').val(), form_cookie: a('input[name="form_cookie"]').val(), preview: "Preview Reply", message: b };
            ...
            "new" == x && (e.adv_post_disabled ? (b = null, d.keyup(function() {
                C != d[0].value.length && (v(), p());
            })) : (j = a("<textarea></textarea>"), j.css({ position: "absolute", left: -2E3, top: d.offset().top }), a("body").append(j), d.keydown(Q), u(d[0].value.length),
                z()));
            p();
            d.focus();
        }
...
SA.thread = new function(e, f, a) {
    ...
    a(f).ready(function() {
        ...
        a("body.showpost").length || (a.browser.msie && 7 > parseInt(a.browser.version, 10) ? (c.show(), a("body").append(c)) : (a("body").append(b), a("body").append(c), a(f).mousemove(function(d) {
            var f = b.is(":visible"), g = c.is(":visible"), i = d.pageY > a(k).scrollTop() + a(e).height() - 100;
...
new function(e, f, a) {
    ...
    a(f).ready(function() {
        ...
        a(f).delegate("div.thread_tags a.if",
            "click", function(b) {
                if (b.shiftKey) {
                    ...
                    if (!b)
                        return !1;
                    var b = b[1], c = SA.utils.qs(), d = null;
                    if (c.posticon)
                        if (-1 == ("," + c.posticon).indexOf("," + b)) {
                            d = c.posticon.split(",");
                            for (d.push(b); 10 < d.length;)
                                d.shift();
                            c.posticon = d.join(",");
                        } else
                            return !1;
        ...
        if (a("body.forum_26, body.forum_154").length)
            ...
            !a.browser.opera && !SA.utils.isMobile && a("body.forum_25").length)
            d = a('<div id="gc_overlay"></div>'), a("body").append(d);
